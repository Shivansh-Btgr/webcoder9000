...
const ProjectDetail = ({ project, files, onEdit, onDelete, onBack, onCreateFile, onImportFile, onFileClick }) => {
      ...
      <div className="dashboard-split-container" style={{flexDirection: 'column', maxWidth: 700}}>
        <div className="project-detail-header-row">
          ...
          <div>
            ...
            <button className="create-btn" onClick={onImportFile} style={{marginRight: '0.7rem'}}>Import File</button>
